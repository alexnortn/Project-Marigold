...
},{"./global.js":2,"jquery":5,"jquery-hammerjs":4}],2:[function(require,module,exports){
/*
...
$(document).ready(function () {
    ...
    $('.image-grid-container').click(function () {
        ...
        $(containerId).children('.image-grid-container').removeClass("active-grid").addClass("bounce-sm");

        $(this).removeClass("bounce-sm").addClass("active-grid");

        if (!overlaySlider.hasClass('slick-initialized')) {

            $(containerId).children('.image-grid-container').removeClass("bounce").addClass('bounce-sm shrink-grid');
        ...
        overlaySlider.on('swipe', function (event) {
            ...
            var activeSlide = $(containerId).find("[data-slide='" + currentSlide + "']");
...
function navUpdate(_sectionCurrent) {
    ...
    if ($(_sections[_sectionCurrent]).data('inproject')) {
        ...
        $('.nav-footer').removeClass('.dark-nav').addClass('.white-nav');
    } else {

        $('.nav-footer').removeClass('.white-nav').addClass('.dark-nav');
    }
}
...
},{"slick-carousel":6,"velocity-animate":7,"velocity-ui-pack":8}],3:[function(require,module,exports){
...
},{"hammerjs":3,"jquery":5}],5:[function(require,module,exports){
/*!
