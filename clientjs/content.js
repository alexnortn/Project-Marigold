{
    ...
    "projects" : [
        ...
        },
        {
            ...
            "description" : {
                "quote": "Unpacking a dream within a dream within an interface.",
                "brief": "Inception is full of puzzling paradox. The 2010 movie offers a thrilling glimpse into an alternate reality where a new technology, enables people to experience dreams together. Cobb, the movies protogonist, played by Leonardo DeCaprio, is tasked with not stealing but planting an idea into the mind of a CEO. The movie descends through colvoluted levels of dreams within dreams. As the heroes move deeper, the stakes quickly rise. Director, Christopher Nolan leaves the audience with an ambiguous ending—has Cobb finally returned to his family or does he remain in limbo?",
                "challenge": "Can design help us to understand the film's final resolution? My partner Sean and I asked why not find inspiration in the very complexity that we seek to understand. Instead of attempting to reduce the Inception's inherent comlexity, which I would argue is sort of the point, could we design a system of tools inspired by themes found within the movie? In responsve we created a prototype for an immersive heads up display to enhance Inception in a way that augments the viewing experience. A typical media player interface is an intrusion onto stage of the screen. Could the viewer be as interested in the data on a heads up display as the movie itself?"
            },
            "meta" : {
                "Client" : "Student",
                "Year" : 2015,
