...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "case-study case-study-window item case-study-item endeavor-height-100vw endeavor-height-600px-mobile"}, {'data-inproject': false}, {'data-projectIndex': index}, {'data-project': data.route},  {'id': data.preview} ]), false)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-pos-rel","endeavor-width-100vw","endeavor-height-500px",`${_class}`], [false,false,false,true]), false, false)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Ch1" + (" class=\"endeavor-process endeavor-text-center endeavor-no-padding\""+pug_attr("style", pug_style(`color: ${textColor}`), true, false)) + "\u003E";
;pug_debug_line = 152;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
