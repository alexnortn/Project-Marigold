...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item endeavor-width-100vw endeavor-bg endeavor-bg-center endeavor-pos-rel\""+pug_attr("style", pug_style(`background-image: url(${data.bg_image.src})`), true, false)) + "\u003E";
