...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["unveil","endeavor-item","veil","endeavor-width-100vw","endeavor-pos-rel",`${_class}`], [false,false,false,false,false,true]),"src": pug_escape(placeholder.src)},{'data-src': image.src}]), false)) + "\u002F\u003E";
};
