...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-width-100vw","endeavor-bg-200","endeavor-bg-center","endeavor-pos-rel","endeavor-pos-rel","endeavor-transition-250","endeavor-no-flow",`${_class}`], [false,false,false,false,false,false,false,true]), false, false)+pug_attr("id", `${_id}`, true, false)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-width-100vw","endeavor-bg-200","endeavor-bg-center","endeavor-pos-rel","endeavor-transition-250","endeavor-no-flow",`${_class}`], [false,false,false,false,false,false,true]), false, false)+pug_attr("id", `${_id}`, true, false)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, false)) + "\u003E";
