...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes([_class], [true]), false, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cvideo" + (" class=\"fsw\""+pug_attr("loop", loop, true, false)+pug_attr("muted", muted, true, false)+pug_attr("autoplay", autoplay, true, false)) + "\u003E";
