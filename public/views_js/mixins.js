...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item endeavor-item-no-margim endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-flex-start fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, false)) + "\u003E";
;pug_debug_line = 311;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["img-load","veil",`${sizeClass}`], [false,false,true]),"src": pug_escape(image.src)},{'data-src': image.src}]), false)) + "\u002F\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item endeavor-item-no-margim endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-flex-end fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item fsw\""+pug_attr("style", pug_style(`height: ${_height}`), true, false)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item endeavor-width-100vw endeavor-bg endeavor-bg-center endeavor-pos-rel\""+pug_attr("style", pug_style(`background-image: url(${bgImage.src});background-color: ${bgColor}`), true, false)) + "\u003E";
