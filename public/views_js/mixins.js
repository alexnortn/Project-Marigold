...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["lazyload","endeavor-item","blur-up","fsw",_class], [false,false,false,false,true]),"src": pug_escape(image.src_low)},{'data-src': image.src}, {'data-srcset': sources}]), false)) + "\u002F\u003E";
};
...
;pug_debug_line = 1057;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
var sources = image.src_standard + " 1x, " + image.src_retina + " 2x"
...
pug_html = pug_html + "\u003Cdiv class=\"endeavor-padding-top-25\"\u003E";
