...
pug_html = pug_html + "\u003Chr" + (" class=\"slight endeavor-item-top-10 fsw\""+pug_attr("style", pug_style(`border-color: ${textColor}`), true, true)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["img-load","endeavor-second","veil",`${sizeClass}`], [false,false,false,true]),"src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["img-load","veil",`${sizeClass}`], [false,false,true]),"src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load veil","style": pug_escape(pug_style(`width: ${size};height: ${size}`)),"src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item veil fsw","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
;pug_debug_line = 441;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item veil endeavor-width-40-prcnt endeavor-pos-rel endeavor-top-minus-15vw endeavor-flex-self-center endeavor-shadow-50","src": pug_escape(placeholder.src)},{'data-src': image2.src}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item veil endeavor-width-100vw endeavor-pos-rel","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item-top-none veil fsw","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item-no-margin veil fsw","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item-bottom-none veil fsw","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item-top-none veil endeavor-width-75-percent","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item veil endeavor-width-75-percent","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-item-25 veil endeavor-width-75-percent","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
  }
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load limit-width-50vw big-moment-3-color endeavor-image-box--center","src": pug_escape(`${placeholder.src}`)},{'data-src': image.src}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
  }
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-width-50-prcnt img-box endeavor-image-box--center","src": pug_escape(`${placeholder.src}`)},{'data-src': image.src}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load endeavor-image-slider-color fsw","src": pug_escape(placeholder.src)},{'data-src': images[i].src}]), true)) + "\u003E";
  }
...
pug_html = pug_html + "\u003Cimg" + (" class=\"img-load endeavor-width-40-prcnt\""+pug_attr("src", `${image.src}`, true, true)) + "\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cimg" + (" class=\"img-load endeavor-width-40-prcnt\""+pug_attr("src", `${image.src}`, true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load veil fsw","src": pug_escape(placeholder.src)},{'data-src': image_top.src}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "img-load veil fsw","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
  }
