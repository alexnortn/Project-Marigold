...
pug_html = pug_html + "\u003Clink href=\"https:\u002F\u002Ffonts.googleapis.com\u002Fcss?family=Source+Sans+Pro:200,300,400,600,700\" rel=\"stylesheet\"\u003E\n\u003Cmeta name=\"theme-color\" content=\"#232323\"\u003E\n\u003C!-- Windows Phone --\u003E\n\u003Cmeta name=\"msapplication-navbutton-color\" content=\"#232323\"\u003E\n\u003C!-- iOS Safari --\u003E\n\u003Cmeta name=\"apple-mobile-web-app-status-bar-style\" content=\"#232323\"\u003E\n\u003Cmeta name=\"viewport\" content=\"user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1\"\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-flex","endeavor-flex-nowrap","endeavor-flex-between","endeavor-width-75-prcnt","endeavor-center","endeavor-flex-center","endeavor-height-100-prcnt",_class], [false,false,false,false,false,false,false,false,true]), false, true)+" id=\"progress-container\"") + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "endeavor-element case-study case-study-window item case-study-item endeavor-height-1000px-responsive endeavor-height-600px-mobile"}, {'data-inproject': false}, {'data-projectIndex': index}, {'data-project': data.route},  {'id': data.preview} ]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cli" + (pug_attrs(pug_merge([{"class": "endeavor-element select-work-item item project-item"}, {'data-inproject': false}, {'data-projectIndex': index}, {'data-project': data.route}, {'id': data.preview} ]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw","endeavor-text-center",`${_class}`], [false,false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Ch3" + (" class=\"endeavor-center endeavor-text-center endeavor-transition-500\""+pug_attr("style", pug_style(`color: ${textColor}`), true, true)) + "\u003E";
;pug_debug_line = 177;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
...
pug_html = pug_html + "\u003Ch3" + (" class=\"endeavor-center endeavor-text-center endeavor-transition-500 endeavor-flex-self-center\""+pug_attr("style", pug_style(`color: ${textColor}`), true, true)) + "\u003E";
;pug_debug_line = 192;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": pug_classes(["endeavor-element","endeavor-process","endeavor-pos-rel","endeavor-width-100vw","endeavor-height-500px","endeavor-height-500px-1000","endeavor-bg-black",`${_class}`], [false,false,false,false,false,false,false,true])},{ 'data-process': process }]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-pos-rel","endeavor-flex-self-center","endeavor-width-100-prcnt","endeavor-height-750px","endeavor-height-500px-1000","endeavor-bg-black",`${_class}`], [false,false,false,false,false,false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","cf",`${_class}`], [false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw",`${_class}`], [false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-flex-column","endeavor-flex-center","fsw",`${_margin}`], [false,false,false,false,true]), false, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item-top-125 endeavor-flex-column endeavor-flex-center fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-flex-between fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
;pug_debug_line = 425;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-second blur-up","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}, {'class':sizeClass}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload blur-up","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}, {'class':sizeClass}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-item-no-margin endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-flex-start fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload blur-up","style": pug_escape(pug_style(`width: ${size};height: ${size}`)),"src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-item-no-margin endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-flex-end fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-height-25vw endeavor-flex-start fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-horizontal-10vw endeavor-flex-row-nowrap endeavor-flex-center-main endeavor-height-25vw endeavor-flex-end fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-element endeavor-item endeavor-flex-column endeavor-flex-center-main\""+pug_attr("style", pug_style(`margin-bottom: ${marginBottom}`), true, true)) + "\u003E";
;pug_debug_line = 563;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload blur-up fsw","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload blur-up endeavor-width-125-percent","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cvideo" + (" class=\"lazyload fsw endeavor-pos-rel endeavor-top-minus-10vw endeavor-flex-self-center endeavor-shadow-50 endeavor-border-32-responsive\""+pug_attr("loop", loop, true, true)+pug_attr("muted", muted, true, true)+pug_attr("autoplay", autoplay, true, true)+pug_attr("data-poster", poster, true, true)+" preload=\"none\""+pug_attr("data-src", webm, true, true)+pug_attr("data-srcset", sourcesVideo, true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["endeavor-element","lazyload","blur-up","fsw",_class], [false,false,false,false,true]),"src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["endeavor-element","lazyload","blur-up","endeavor-width-100vw","endeavor-pos-rel",`${_class}`], [false,false,false,false,false,true]),"src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item-top-none blur-up fsw","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item-no-margin blur-up fsw","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item endeavor-item-bottom-none blur-up fsw","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item-top-none blur-up endeavor-width-75-percent","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["endeavor-element","lazyload","fsw",_class], [false,false,false,true]),"src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-width-100vw","endeavor-pos-rel",_class], [false,false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["lazyload","fsw",_class2], [false,false,true]),"src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item blur-up endeavor-width-75-percent","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-element lazyload endeavor-item-25 blur-up endeavor-width-75-percent","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_html = pug_html + "\u003Ciframe" + (" class=\"endeavor-element endeavor-item media-settings media-frame video-settings\""+" width=\"1920\" height=\"1080\""+pug_attr("src", video.src, true, true)+" frameborder=\"0\""+pug_attr("allowfullscreen", true, true, true)) + "\u003E\u003C\u002Fiframe\u003E";
};
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element",_class], [false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cvideo" + (" class=\"lazyload fsw\""+pug_attr("loop", loop, true, true)+pug_attr("muted", muted, true, true)+pug_attr("autoplay", autoplay, true, true)+pug_attr("data-poster", poster, true, true)+" preload=\"none\""+pug_attr("data-src", webm, true, true)+pug_attr("data-srcset", sources, true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Ciframe" + (pug_attrs(pug_merge([{"class": "endeavor-element endeavor-item lazyload media-settings media-frame pub-settings","src": "","frameborder": "0","allowfullscreen": pug_escape(true)},{'data-src': pub.src}]), true)) + "\u003E\u003C\u002Fiframe\u003E";
};
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw",`${_class}`], [false,false,true]), false, true)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload limit-width-50vw big-moment-3-color endeavor-image-box--center","src": pug_escape(`${image.src_low}`)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
    for (var i in $$obj) {
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload img-box endeavor-parallax-hybrid-left-img-box parallax__layer parallax__layer--fore","src": pug_escape(`${imageParallax.src_low}`)},{'data-src': imageParallax.src}, {'data-srcset': sources}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload img-box endeavor-parallax-hybrid-right-img-box parallax__layer parallax__layer--fore","src": pug_escape(`${imageParallax.src_low}`)},{'data-src': imageParallax.src}, {'data-srcset': sources}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-width-50-prcnt img-box endeavor-image-box--center","src": pug_escape(`${image.src_low}`)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-image-slider",_class], [false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "endeavor-image-slider-color fsw","src": "data:image\u002Fgif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="},{'data-src': images[i].src}]), true)) + "\u003E";
      }
  } else {
    var $$l = 0;
    for (var i in $$obj) {
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-image-slider","endeavor-width-75-prcnt","endeavor-center",_class], [false,false,false,false,true]), false, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-width-40-prcnt","src": pug_escape(`${image.src_low}`)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-width-40-prcnt","src": pug_escape(`${image.src_low}`)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-width-100vw","endeavor-bg-200","endeavor-bg-center","endeavor-pos-rel","endeavor-pos-rel","endeavor-transition-1000","endeavor-no-flow",`${_class}`], [false,false,false,false,false,false,false,false,true]), false, true)+pug_attr("id", `${_id}`, true, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-width-100vw","endeavor-bg-200","endeavor-bg-center","endeavor-pos-rel","endeavor-transition-1000","endeavor-no-flow",`${_class}`], [false,false,false,false,false,false,false,true]), false, true)+pug_attr("id", `${_id}`, true, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw","endeavor-transition-1000","endeavor-no-flow",`${_class}`], [false,false,false,false,true]), false, true)+pug_attr("id", `${_id}`, true, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw","endeavor-center","endeavor-padding-left-100-1000","endeavor-padding-left-0-mobile",`${_class}`], [false,false,false,false,false,true]), false, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cli" + (pug_attrs(pug_merge([{"class": "endeavor-item-left-50 endeavor-item-bottom-15 endeavor-inline-block endeavor-max-width-400 endeavor-min-width-275px-500 checklist"},{'class': _class4}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "fsw endeavor-flex endeavor-flex-between endeavor-flex-wrap endeavor-transition-ease-500 endeavor-height-auto endeavor-no-flow"},{'class': _class2}, {'id': _id}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "endeavor-width-100-prcnt-600px endeavor-flex endeavor-flex-between endeavor-flex-wrap endeavor-transition-ease-500 endeavor-height-auto endeavor-no-flow"},{'class': _class2}, {'id': _id}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-item blur-up fsw","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}]), true)) + "\u003E";
      }
  } else {
    var $$l = 0;
    for (var index in $$obj) {
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","fsw","endeavor-center","endeavor-padding-left-0-mobile",`${_class}`], [false,false,false,false,true]), false, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload endeavor-second blur-up","src": pug_escape(image.src_low)},{'data-sizes': "auto"}, {'data-srcset': sources}, {'class':sizeClass}]), true)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "lazyload blur-up fsw","src": pug_escape(image_top.src_low)},{'data-srcset': sources_top}]), true)) + "\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-element","endeavor-flex-row-nowrap","endeavor-flex-around","endeavor-padding-bottom-50",`${_class}`], [false,false,false,false,true]), false, true)) + "\u003E";
...
;(function(){
  var $$obj = case_studies;
  if ('number' == typeof $$obj.length) {
      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
        var item = $$obj[index];
;pug_debug_line = 25;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "endeavor endeavor-view case-study-view parallax"},{'data-inproject': false}, {'data-projectIndex': index}, {'id': item.route}]), true)) + "\u003E";
...
pug_mixins["endeavorHeader"](item);
...
pug_html = pug_html + "\u003Cdiv class=\"header plus_plus\" id=\"header\"\u003E";
...
pug_html = pug_html + "\u003Cinput class=\"lab-radio\" type=\"radio\" name=\"lab-radio\" id=\"fluid-radio\" value=\"1\"\u003E";
...
pug_html = pug_html + "\u003Cinput class=\"lab-radio\" type=\"radio\" name=\"lab-radio\" id=\"perlin-radio\" value=\"2\" checked=\"checked\"\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"scroll-arrow plus\"\u003E";
;pug_debug_line = 131;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "\u003Ci class=\"fa  fa-angle-down fa-2x medium-text-2\"\u003E";
;pug_debug_line = 131;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
...
pug_html = pug_html + "\u003Cimg src=\"\u002Fimages\u002Fname.svg\" alt=\"Alex Norton\"\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Ch4 id=\"bios-about\"\u003E";
;pug_debug_line = 147;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
...
;pug_debug_line = 148;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + (null == (pug_interp = bios_text.description_short_2) ? "" : pug_interp) + "\u003C\u002Fp\u003E";
...
pug_html = pug_html + "\u003Ch3 class=\"endeavor-center endeavor-text-center endeavor-transition-500\"\u003E";
;pug_debug_line = 151;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "Read more\u003C\u002Fh3\u003E\u003C\u002Fbutton\u003E";
...
pug_html = pug_html + "\u003Cbutton class=\"endeavor-button flat endeavor-center-mobile\"\u003E";
;pug_debug_line = 154;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "\u003Ch3 class=\"endeavor-center endeavor-text-center endeavor-transition-500 medium-text-2\"\u003E";
;pug_debug_line = 154;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "Résumé\u003C\u002Fh3\u003E\u003C\u002Fbutton\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E";
...
pug_html = pug_html + "\u003Cscript src=\".\u002Fplugins\u002Fwidowtamer\u002Fwidowtamer.js\"\u003E\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";}.call(this,"_class" in locals_for_with?locals_for_with._class:typeof _class!=="undefined"?_class:undefined,"bios_text" in locals_for_with?locals_for_with.bios_text:typeof bios_text!=="undefined"?bios_text:undefined,"case_studies" in locals_for_with?locals_for_with.case_studies:typeof case_studies!=="undefined"?case_studies:undefined,"contact" in locals_for_with?locals_for_with.contact:typeof contact!=="undefined"?contact:undefined,"feature" in locals_for_with?locals_for_with.feature:typeof feature!=="undefined"?feature:undefined,"projects" in locals_for_with?locals_for_with.projects:typeof projects!=="undefined"?projects:undefined,"sizeClass" in locals_for_with?locals_for_with.sizeClass:typeof sizeClass!=="undefined"?sizeClass:undefined,"sources" in locals_for_with?locals_for_with.sources:typeof sources!=="undefined"?sources:undefined,"textColor" in locals_for_with?locals_for_with.textColor:typeof textColor!=="undefined"?textColor:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"welcome_text" in locals_for_with?locals_for_with.welcome_text:typeof welcome_text!=="undefined"?welcome_text:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}