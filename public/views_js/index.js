...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-pos-rel","endeavor-width-100vw","endeavor-height-750px","endeavor-height-500px-1000",`${_class}`], [false,false,false,false,true]), false, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Ch1" + (" class=\"endeavor-process endeavor-text-center endeavor-no-padding\""+pug_attr("style", pug_style(`color: ${textColor2}`), true, true)) + "\u003E";
;pug_debug_line = 173;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Fmixins.pug";
