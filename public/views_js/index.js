...
pug_html = pug_html + "\u003Cdiv" + (" class=\"big-moment-1-color parallax__layer--back\""+pug_attr("style", pug_style(`background-image: url(${result.images[index].src})`), true, true)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"big-moment-2-color\""+pug_attr("style", pug_style(`background-image: url(${result.images[index].src})`), true, true)) + "\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 214;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv" + (" class=\"img-box parallax__layer parallax__layer--fore\""+pug_attr("style", pug_style(`background-image: url(${result.images[index].src})`), true, true)) + "\u003E\u003C\u002Fdiv\u003E";
