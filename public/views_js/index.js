...
var pug_obj34 = case_study.sections;
if ('number' == typeof pug_obj34.length) {

  for (var iindex = 0, pug_length34 = pug_obj34.length; iindex < pug_length34; iindex++) {
    var section = pug_obj34[iindex];
...
// iterate projects
var pug_obj36 = projects;
if ('number' == typeof pug_obj36.length) {

  for (var index = 0, pug_length36 = pug_obj36.length; index < pug_length36; index++) {
    var project = pug_obj36[index];
...
var pug_obj37 = project.sections;
...
// iterate case_studies
var pug_obj39 = case_studies;
if ('number' == typeof pug_obj39.length) {

  for (var index = 0, pug_length39 = pug_obj39.length; index < pug_length39; index++) {
    var case_study = pug_obj39[index];
