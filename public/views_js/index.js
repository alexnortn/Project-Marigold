...
pug_html = pug_html + "\u003Cdiv" + (" class=\"endeavor-item endeavor-intro endeavor-50 endeavor-flex-column endeavor-flex-center fsw\""+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
