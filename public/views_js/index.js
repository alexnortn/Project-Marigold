...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": "unveil endeavor-item veil endeavor-width-100vw endeavor-pos-rel","src": pug_escape(placeholder.src)},{'data-src': image.src}]), true)) + "\u003E";
};
