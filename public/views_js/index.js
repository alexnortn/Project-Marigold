...
pug_html = pug_html + "\u003Cimg" + (pug_attrs(pug_merge([{"class": pug_classes(["lazyload","endeavor-item","blur-up","fsw",_class], [false,false,false,false,true]),"src": pug_escape(image.src_low)},{'data-src': image.src}, {'data-srcset': sources}]), true)) + "\u003E";
};
...
pug_html = pug_html + "\u003Cvideo" + (pug_attr("class", pug_classes([_class], [true]), false, true)+pug_attr("loop", loop, true, true)+pug_attr("muted", muted, true, true)+pug_attr("autoplay", autoplay, true, true)) + "\u003E";
...
pug_html = pug_html + "\u003Cul" + (pug_attrs(pug_merge([{"class": "fa-ul endeavor-width-100-prcnt endeavor-padding-vertical-5-mobile endeavor-padding-top-25"},{'class': _class3}]), true)) + "\u003E";
...
var pug_obj35 = case_study.sections;
if ('number' == typeof pug_obj35.length) {

  for (var iindex = 0, pug_length35 = pug_obj35.length; iindex < pug_length35; iindex++) {
    var section = pug_obj35[iindex];
...
// iterate projects
var pug_obj37 = projects;
if ('number' == typeof pug_obj37.length) {

  for (var index = 0, pug_length37 = pug_obj37.length; index < pug_length37; index++) {
    var project = pug_obj37[index];
...
var pug_obj38 = project.sections;
if ('number' == typeof pug_obj38.length) {

  for (var iindex = 0, pug_length38 = pug_obj38.length; iindex < pug_length38; iindex++) {
    var section = pug_obj38[iindex];
...
// iterate case_studies
var pug_obj40 = case_studies;
if ('number' == typeof pug_obj40.length) {

  for (var index = 0, pug_length40 = pug_obj40.length; index < pug_length40; index++) {
    var case_study = pug_obj40[index];
...
pug_html = pug_html + "\u003Csection class=\"feature endeavor-vertical-250 endeavor-bg-graydient\" id=\"feature\"\u003E";
