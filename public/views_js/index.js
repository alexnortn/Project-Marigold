...
pug_html = pug_html + "\u003Cdiv" + (pug_attrs(pug_merge([{"class": "endeavor case-study-view parallax"}, {'data-inproject': false}, {'data-projectIndex': i}, {'data-project': result.route}, {'id': result.route} ]), true)) + "\u003E";
