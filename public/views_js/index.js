...
pug_html = pug_html + "\u003Cdiv" + (pug_attr("class", pug_classes(["endeavor-width-100vw","endeavor-transition-1000","endeavor-no-flow",`${_class}`], [false,false,false,true]), false, true)+pug_attr("id", `${_id}`, true, true)+pug_attr("style", pug_style(`background-color: ${bgColor}`), true, true)) + "\u003E";
...
;pug_debug_line = 39;pug_debug_filename = "\u002FUsers\u002Falexnortn\u002FDocuments\u002FGithub\u002FPortfolio\u002Fviews\u002Findex.pug";
// iterate project.sections
var pug_obj28 = project.sections;
if ('number' == typeof pug_obj28.length) {

  for (var iindex = 0, pug_length28 = pug_obj28.length; iindex < pug_length28; iindex++) {
    var section = pug_obj28[iindex];
